...
export function registerGridCommand(program: Command): void {
  ...
  grid
    ...
    .option('--leverage <n>', 'Leverage multiplier', String(DEFAULT_GRID_CONFIG.leverage))
    .option('--levels <n>', 'Grid levels per side', String(DEFAULT_GRID_CONFIG.levelsPerSide))
  ...
  grid
    ...
    .action(async (opts) => {
      ...
      const config: GridConfig = {
        ...
        stopLossPct: opts.stopLoss !== undefined ? Number(opts.stopLoss) : DEFAULT_GRID_CONFIG.stopLossPct,
      };
