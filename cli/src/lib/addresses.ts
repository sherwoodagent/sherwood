...
const HYPEREVM_SHERWOOD = {
  FACTORY: "0x7e7F8Ee0f451aA70be3dda66D9eeecbfc7FA48d3" as Address,
  GOVERNOR: "0x915Fc671F4b96420266200ec21Af8dD69Ec97C21" as Address,
  GUARDIAN_REGISTRY: "0x121AaC2B96Ec365e457fcCc1C2ED5a6142064069" as Address,
  WOOD_TOKEN: ZERO,
  MERKL_DISTRIBUTOR: ZERO,
} as const;
...
const BASE_STRATEGY_TEMPLATES = {
  ...
  HYPERLIQUID_GRID: ZERO as Address,
...
const HYPEREVM_STRATEGY_TEMPLATES = {
  ...
  WSTETH_MOONWELL: ZERO as Address,
  MAMO_YIELD: ZERO as Address,
  HYPERLIQUID_PERP: "0xa2B8Ad8695FdE05bf1DA4aBaef1608045A53Ba4E" as Address,
  HYPERLIQUID_GRID: "0x49BFDae8353ba15954924274573D427211CCe41b" as Address,
  PORTFOLIO: ZERO as Address,
} as const;
