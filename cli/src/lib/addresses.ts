...
const BASE_SHERWOOD = {
  FACTORY: "0x7ffBd8D58C60328773Eb2B170b5505768a901AD4" as Address,
  GOVERNOR: "0x8599ECDdEC4C969ec9E1f3AEE894afd70365AaC2" as Address,
} as const;

const BASE_SEPOLIA_SHERWOOD = {
  FACTORY: "0xd882056ba6b0aEd8908c541884B327121E2f2C9C" as Address,
  GOVERNOR: "0x25E33fAeE061E752fDFe851911ccC4C6D9FBA346" as Address,
} as const;

const ROBINHOOD_TESTNET_SHERWOOD = {
  FACTORY: "0xc31B426683C124D3Cb328B0C8396e5caf821B1C5" as Address,
  GOVERNOR: "0x7eAbBbccdBf511c91ebBfd1353201758C62B725B" as Address,
} as const;
